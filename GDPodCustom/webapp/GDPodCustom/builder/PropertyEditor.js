sap.ui.define([
    ...
    return PropertyEditor.extend( "kpmg.custom.pod.GDPodCustom.GDPodCustom.builder.PropertyEditor" ,{

		constructor: function(sId, mSettings){
			PropertyEditor.apply(this, arguments);
			
			this.setI18nKeyPrefix("customComponentListConfig.");
			this.setResourceBundleName("kpmg.custom.pod.GDPodCustom.GDPodCustom.i18n.builder");
			this.setPluginResourceBundleName("kpmg.custom.pod.GDPodCustom.GDPodCustom.i18n.i18n");
		},
